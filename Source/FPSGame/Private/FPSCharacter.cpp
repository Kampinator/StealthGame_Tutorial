...
{
	UE_LOG(LogTemp, Warning, TEXT("sfsef"));
	...
	if (ProjectileClass)
	{
		...
		// We are the instigator for the shot bullet.
...
void AFPSCharacter::Tick(float DeltaTime)
{
	...
	// Only change pitch if we are not locally controlling character
	if(!IsLocallyControlled())
	{ 
		FRotator NewRot = CameraComponent->RelativeRotation;
		// RemoteViewPitch is replicated in Pawn.h. We know where client is looking.
		// Pawn.h compresses pitch. We uncompressing here
